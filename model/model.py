...
class Model:
    ...
    def __init__(self, mod: Mod, path_to_dir: str, stg_num: int, usr_num: int,
        ...
        self.stgs = [StgNode(mod, os.path.join(self.path, STG_DIR, f"stg_{i}")) for i in range(self.stg_num)]
        self.usrs = [UsrNode(mod, os.path.join(self.path, USR_DIR, f"usr_{i}"),
